...
public final class CacheManager {
    ...
    private let queue = DispatchQueue(label: "com.skyfeeder.cachemanager")
    ...
    public func data(forKey key: String, ttl: TimeInterval, category: Category) -> Data? {
    ...
    @discardableResult
    public func store(data: Data, forKey key: String, category: Category) throws -> URL {
        let url = fileURL(for: key, category: category)
    ...
    public func url(forKey key: String, category: Category) -> URL {
        fileURL(for: key, category: category)
    }

    public func clearExpired(ttl: TimeInterval, category: Category) {
    ...
    private func fileURL(for key: String, category: Category) -> URL {
        ...
        return directory.appendingPathComponent(hashed, isDirectory: false)
    }
