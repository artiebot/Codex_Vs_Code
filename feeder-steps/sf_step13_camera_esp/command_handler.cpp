...
void SF_registerCommandSubscriptions(PubSubClient& client){ client.subscribe(TOPIC_CMD_LED,1); client.subscribe(TOPIC_CMD_CALIBRATE,1); client.subscribe(TOPIC_CMD_CAMERA,1); }
