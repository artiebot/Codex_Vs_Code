# Stage WiFi credentials for Mini camera
# Usage: .\cam-wifi-stage.ps1 -Ssid "YourSSID" -Psk "YourPassword" -Token "optional-token"
...
Write-Host "Staging WiFi credentials..." -ForegroundColor Green
Write-Host "SSID: $Ssid" -ForegroundColor Yellow
...
$tempFile = "payload_wifi_stage.json"
