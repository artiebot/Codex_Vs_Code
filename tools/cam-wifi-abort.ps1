# Abort staged WiFi credentials on Mini camera
# Usage: .\cam-wifi-abort.ps1 -Token "tok-002"
...
Write-Host "Aborting WiFi credentials..." -ForegroundColor Red
...
$tempFile = "payload_wifi_abort.json"
